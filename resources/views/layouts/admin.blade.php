...
<html lang="en">
   ...
   <body class="dashboard dashboard_1">
            ...
            <nav id="sidebar">
                     ...
                     <div class="user_profle_side">
                        <div class="user_img">
                           <img class="img-responsive"
                              src="{{ auth()->user()->profile_photo ? asset('storage/' . auth()->user()->profile_photo) : 'https://cdn.jsdelivr.net/gh/themewagon/pluto@master/images/layout_img/user_img.jpg' }}"
                              alt="#"
                              onerror="this.src='https://via.placeholder.com/75x75?text=User'"
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li class="{{ request()->routeIs('admin.settings.frontend') ? 'active' : '' }}">
                        <a href="{{ route('admin.settings.frontend') }}"><i class="fa fa-desktop blue2_color"></i> <span>Konten Front End</span></a>
                     </li>
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown">
                                       ...
                                       <span class="name_user">{{ auth()->user()->name ?? 'Admin' }}</span>
                                    </a>
      ...
      <script src="https://cdn.jsdelivr.net/gh/themewagon/pluto@master/js/owl.carousel.js"></script>
      <script src="https://cdn.jsdelivr.net/gh/themewagon/pluto@master/js/Chart.min.js"></script>
      <script src="https://cdn.jsdelivr.net/gh/themewagon/pluto@master/js/Chart.bundle.min.js"></script>
      <script src="https://cdn.jsdelivr.net/gh/themewagon/pluto@master/js/utils.js"></script>
      <script src="https://cdn.jsdelivr.net/gh/themewagon/pluto@master/js/analyser.js"></script>
